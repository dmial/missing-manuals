...
Коллекция технических заметок по принципу «missing manual» — закрываю в них пробелы, которые типичные источники по теме обходят, скомкивают или размазывают по главам.
